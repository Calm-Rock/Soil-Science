...
y=np.asarray(pd.read_csv('/home/somchakr/different_features_values_of_all_samples.csv')['carbon_percent'])
Y=[]
...
y=np.concatenate(Y)
images = []
for image_path in sorted(os.listdir('/home/somchakr/Final_numbered_images_CNN')):
